...
public class TaskTest {
    ...
    public void urgentTaskTest() {
        ...
        testTask.setDueDate("");
        assertEquals(testTask.getUrgency(), Urgency.UrgentTask);
    ...
    public void regularTaskTest() {
        ...
        assertEquals(testTask.getUrgency(), Urgency.RegularTask);
    ...
    public void ongoingTaskTest() {
        ...
        testTask.setDueDate("");
        assertEquals(testTask.getUrgency(), Urgency.OngoingTask);
    ...
    @Test void toJsonTest() {
        testTask =new OngoingTask("Volunteering");
        String json = "{\"urgency\":\"OngoingTask\",\"task name\":\"Volunteering\"}";
        assertEquals(testTask.toJson().toString(), json);
    }
