...
// Represents a completed list of task on the gui
public class CompletedTaskList extends JPanel
    ...
    public CompletedTaskList() {
        ...
        listModel.addElement("Completions: " + myList.getCompletedSize() + " completed tasks");
        for (Task task : myList.getCompletedList()) {
